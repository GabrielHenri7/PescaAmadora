...
Console.WriteLine("--- Atividade Pesca Amadorahj ---\n");
...
{
    Console.WriteLine("Pescaria dentro dos limites.");
    return;
}
...
Console.WriteLine($"Pescaria excede os limites em {pesoExcesso}kg.\nSujeito a multa de {multa:C}.");
